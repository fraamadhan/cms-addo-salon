...
export const ModalAddEmployee = (
    ...
    const { control, register, handleSubmit, formState: { errors } } = useForm<z.infer<typeof UpdateEmployeeSchema>>({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-lg space-y-4 z-10">
                <h2 className="text-xl font-bold">Tambah Data Pegawai</h2>
                <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-end gap-2 mt-7 w-full">
                        <Button type="button" onClick={onClose} className="px-4 py-2 w-[15rem] text-sm bg-gray-200 rounded hover:bg-gray-300">
                            Batal
                        </Button>
                        {
                            mutation.isPending ? (
