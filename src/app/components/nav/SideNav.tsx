...
const SideNav = () => {
    ...
    return (
        <nav className="h-full w-full bg-gray-800 text-white shadow-xl flex flex-col justify-evenly p-5">
            ...
            <div className="pt-6">
                <Button className="w-full flex items-start justify-center px-4 py-2 bg-red-100 text-red-500 font-bold rounded-xl gap-x-2 hover:bg-red-200" onClick={onClick}>
                    <span>Keluar</span>
                    <LogOut />
                </Button>
            </div>
